  ...
  return (
    <div className="flex h-screen w-full bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-h-0 w-full min-w-0">
        ...
        >
          <div className={`flex items-center justify-between ${isMobile ? "p-2" : "p-3 md:p-4"}`}>
        ...
        {/* Content */}
        <div className="flex-1 min-h-0 overflow-auto w-full min-w-0" data-dashboard-content>
