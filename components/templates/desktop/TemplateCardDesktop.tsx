...
import { Users, MessageSquare, BarChart3, Star, TrendingUp, Copy, Eye } from "lucide-react"
...
export const TemplateCardDesktop = memo(function TemplateCardDesktop({
  template,
  isSelected,
  onSelect,
  onQuickPreview,
        ...
        <CardContent className="pt-0 pb-3 space-y-3">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {template.metadata.tags.length > 2 && (
              <span className="text-xs text-muted-foreground">+{template.metadata.tags.length - 2}</span>
            )}
          </div>
