  ...
  return (
    ...
    >
      <div className={isMobile ? "flex flex-col h-full" : ""}>
        ...
        <div className={isMobile ? "flex gap-3 px-4 py-4 border-t border-border bg-background" : "flex gap-3 pt-4"}>
          <Button
            type="button"
            variant="outline"
            onClick={handleClose}
            disabled={isSubmitting}
            className="min-h-[48px] flex-1 bg-transparent"
          >
            Cancel
          </Button>
          <Button type="submit" disabled={isSubmitting} onClick={handleSubmit} className="min-h-[48px] flex-1">
